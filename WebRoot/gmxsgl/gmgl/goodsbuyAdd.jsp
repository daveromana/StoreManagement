...
<body>
	<div style="float: right;">
		<font size="5">采购订单添加&nbsp<a href="Buy!datagrid.do">返回</a></font>
	</div>
	<br>
	<table>
		<form action="Buy!add.do?methodType=add" method="post"
		...
		<tr>
			<td>型号</td>
			<td><input name="goodsbuytype" type="text"></td>
		</tr>
		<tr>
			<td>生产地</td>
			<td><input name="goodsbuyaddress" type="text"></td>
		</tr>
		<tr>
			<td>负责人</td>
