...
<body>
	<div style="float: right;">
		<font size="5">货物入库&nbsp<a href="Goodshaving!datagrid.do">返回</a></font>
	</div>
	<br>
	<form action="Goodshaving!add.do?methodType=add" method="post"
		onsubmit="return check()">
		<table>
			<tr>
				<td>商品</td>
				<td><input name="goods" id="goods" type="text"
					></td>
			</tr>
			<tr>
				<td>型号</td>
				<td><input name="goodstype" id="goodstype" type="text"
					></td>
			</tr>
			<tr>
				<td>产地</td>
				<td><input name="goodsaddress" id="goodsaddress" type="text"
					onblur="checkStatus()"></td>
			</tr>
			<tr>
				<td>数量</td>
				<td><input name="num" id="num" type="text" onblur="check()"></td>
			</tr>
			<tr>
				<td>价格</td>
				<td><input name="price" id="price" type="text" onblur="check()"></td>
			</tr>
			<tr>
				<td>客户名</td>
